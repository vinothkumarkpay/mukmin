        ...
        Widget::query()->updateOrCreate(
            ...
            [
                ...
                'settings' => [
                    ...
                    'ctas' => [
                        ['label' => 'Connect With Our Team', 'url' => '/page/cta-partners#contact', 'new_tab' => false],
                    ],
                ],
                'sort_order' => 0,
                'is_active' => true,
            ...
            [
                ...
                'settings' => [
                    ...
                    'ctas' => [
                        ...
                        ['label' => 'Apply Now', 'url' => '/page/cta-partners#register', 'style' => 'ghost', 'new_tab' => false],
                    ],
                ],
                'sort_order' => 10,
                'is_active' => true,
...
HTML
                ...
                'settings' => [
                    ...
                    'cta_label' => 'Learn more',
                    'cta_url' => '/page/cta-partners#contact',
                    'cta_new_tab' => false,
                ],
                'sort_order' => 50,
                'is_active' => true,
        ...
        Widget::query()->updateOrCreate(
            ...
            [
                ...
                'settings' => [
                    ...
                    'cta_url' => '/page/cta-partners#register',
                ],
                'sort_order' => 80,
                'is_active' => true,
            ]
        ...
        Widget::query()->updateOrCreate(
            ...
            [
                ...
                'settings' => [
                    ...
                    'cta_label' => 'Get in Touch',
                    'cta_url' => 'mailto:hello@mukmin.org',
                ],
                'sort_order' => 20,
                'is_active' => true,
            ]
        ...
        Widget::query()->updateOrCreate(
            ...
            [
                ...
                'settings' => [
                    ...
                    'anchor_id' => 'register',
                    'headline' => 'Be Part of the Movement',
                    'subheadline' => 'Registration and interest form (link your live form URL when ready).',
                    'cta_label' => 'Register Now',
                    'cta_url' => 'mailto:register@mukmin.org',
                ],
                'sort_order' => 30,
                'is_active' => true,
            ]
